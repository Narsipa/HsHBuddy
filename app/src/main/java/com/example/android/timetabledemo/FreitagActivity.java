...
public class FreitagActivity extends AppCompatActivity {
    ...
    EditText fach5;
    EditText fach6;
    private static final String mypreference = "freitag";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fach4 = (EditText) findViewById(R.id.frFach4);
        fach5 = (EditText) findViewById(R.id.frFach5);
        fach6 = (EditText) findViewById(R.id.frFach6);
    ...
    public void Save(View view) {
        ...
        Toast.makeText(FreitagActivity.this, "Gespeichert",
