...
public class DienstagActivity extends AppCompatActivity {
    ...
    EditText fach5;
    EditText fach6;
    private static final String mypreference = "dienstag";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fach4 = (EditText) findViewById(R.id.diFach4);
        fach5 = (EditText) findViewById(R.id.diFach5);
        fach6 = (EditText) findViewById(R.id.diFach6);
  ...
  /*  private void initToolbar(){
    ...
    public void Save(View view) {
        ...
        Toast.makeText(DienstagActivity.this, "Gespeichert",
