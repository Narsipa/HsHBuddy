...
public class DonnerstagActivity extends AppCompatActivity {
    ...
    EditText fach5;
    EditText fach6;
    private static final String mypreference = "donnerstag";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fach4 = (EditText) findViewById(R.id.doFach4);
        fach5 = (EditText) findViewById(R.id.doFach5);
        fach6 = (EditText) findViewById(R.id.doFach6);
    ...
    public void Save(View view) {
        ...
        Toast.makeText(DonnerstagActivity.this, "Gespeichert",
